	...
	#define V_COMMIT_HASH "f7cd923cdc5710a7046f0832fd60503d09e7682f"
#endif
...
//     All custom defines      : gcboehm,gcboehm_full,gcboehm_opt,freebsd
//     Turned ON custom defines: gcboehm,gcboehm_full,gcboehm_opt,freebsd
#define CUSTOM_DEFINE_gcboehm
#define CUSTOM_DEFINE_gcboehm_full
#define CUSTOM_DEFINE_gcboehm_opt
#define CUSTOM_DEFINE_freebsd
...
// added by module `main`, file: v_calls_nim.v:4:

#if defined(__has_include)

#if __has_include("libnimlib.h")
#include "libnimlib.h"
#else
#error VERROR_MESSAGE Header file "libnimlib.h", needed for module `main` was not found. Please install the corresponding development headers.
#endif
...
string strconv__f64_to_str(f64 f, int n_digit) {
	...
	multi_return_strconv__Dec64_bool mr_9584 = strconv__f64_to_decimal_exact_int(mant, exp);
	strconv__Dec64 d = mr_9584.arg0;
	bool ok = mr_9584.arg1;
	if (!ok) {
...
string strconv__f64_to_str_pad(f64 f, int n_digit) {
	...
	multi_return_strconv__Dec64_bool mr_10365 = strconv__f64_to_decimal_exact_int(mant, exp);
	strconv__Dec64 d = mr_10365.arg0;
	bool ok = mr_10365.arg1;
	if (!ok) {
		d = strconv__f64_to_decimal(mant, exp);
	}
...
VV_LOC void main__main(void) {
	builtin__println(_S("V calling Nim functions..."));
	int result = addNumbers(10, 20);
	builtin__println(builtin__str_intp(2, _MOV((StrIntpData[]){{_S("addNumbers(10, 20) = "), 0xfe07, {.d_i32 = result}}, {_SLIT0, 0, { .d_c = 0 }}})));
	u8* greeting = greet("V programmer");
	builtin__println(builtin__str_intp(2, _MOV((StrIntpData[]){{_S("Greeting: "), 0xfe11, {.d_p = (void*)(greeting)}}, {_SLIT0, 0, { .d_c = 0 }}})));
	int fib = calculateFibonacci(10);
	builtin__println(builtin__str_intp(2, _MOV((StrIntpData[]){{_S("Fibonacci(10) = "), 0xfe07, {.d_i32 = fib}}, {_SLIT0, 0, { .d_c = 0 }}})));
}
void _vinit(int ___argc, voidptr ___argv) {
